...
async function connect(){error.value="";try{login.value=await request("/owner/codex/login",{method:"POST"})}catch(e){error.value=e instanceof Error?e.message:"Unable to start Codex login"}}
